...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_startService() {
  ...
  jctomb(nm, name);
  jint res = AJ_StartService((AJ_BusAttachment *)ptr, NULL, timeout, connected,
                             port, nm, flags, NULL);
  //	free(dnm);
  free(nm);
  KNI_EndHandles();
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_busAdvertiseName() {
  ...
  jctomb(nm, name);
  jint res =
      AJ_BusAdvertiseName((AJ_BusAttachment *)ptr, nm, transport, op, flags);
  free(nm);
  KNI_EndHandles();
  KNI_ReturnInt(res);
}
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_deliverMsg() {
  ...
  jboolean collect =
      KNI_GetBooleanField(msg, KNI_GetFieldID(msgclass, "collect", "B"));
  ...
  if (collect == KNI_TRUE) {
    ...
    free(nativemsg);
    KNI_SetBooleanField(msg, KNI_GetFieldID(msgclass, "collect", "B"),
                        KNI_FALSE);
  }
  KNI_EndHandles();
  KNI_ReturnInt(res);
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_marshalReplyMsg() {
  ...
  KNI_SetIntField(reply, KNI_GetFieldID(msgclass, "ptr", "I"),
                  (jint)nativereply);
  KNI_SetIntField(reply, KNI_GetFieldID(msgclass, "msgType", "I"),
                  nativereply->hdr->msgType);
  KNI_SetIntField(reply, KNI_GetFieldID(msgclass, "msgId", "I"),
                  nativereply->msgId);
  KNI_SetObjectField(
      reply, KNI_GetFieldID(msgclass, "destination", "Ljava/lang/String;"),
      destination);
  KNI_SetIntField(reply, KNI_GetFieldID(msgclass, "sessionId", "I"),
                  nativereply->sessionId);
  KNI_SetIntField(reply, KNI_GetFieldID(msgclass, "totalLen", "I"),
                  msglen(nativereply));
  KNI_EndHandles();
  KNI_ReturnInt(res);
}
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_deliverRaw() {
  ...
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "totalLen", "I"),
                  msglen((AJ_Message *)ptr));
  KNI_EndHandles();
  KNI_ReturnInt(res);
}
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_marshalSignal() {
  ...
  jint res = AJ_MarshalSignal((AJ_BusAttachment *)ptr, nativemsg, msgId, dest,
                              sessionId, flags, ttl);
  ...
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "msgType", "I"),
                  nativemsg->hdr->msgType);
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "msgId", "I"),
                  nativemsg->msgId);
  KNI_SetObjectField(
      msg, KNI_GetFieldID(msgclass, "destination", "Ljava/lang/String;"),
      destination);
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "sessionId", "I"),
                  nativemsg->sessionId);
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "totalLen", "I"),
                  msglen(nativemsg));
  KNI_EndHandles();
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_unmarshalMsg() {
  ...
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "sessionId", "I"),
                  nativemsg->sessionId);
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "bodyBytes", "I"),
                  nativemsg->bodyBytes);
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "totalLen", "I"),
                  msglen(nativemsg));
  KNI_EndHandles();
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_unmarshalPropertyArgs() {
  ...
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "bodyBytes", "I"),
                  ((AJ_Message *)ptr)->bodyBytes);
  KNI_SetIntField(propid, KNI_GetFieldID(propidclass, "value", "I"), propidval);
  KNI_SetObjectField(
      sig, KNI_GetFieldID(sigclass, "value", "Ljava/lang/String;"), sigvalue);
  KNI_EndHandles();
  KNI_ReturnInt(res);
}
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_unmarshalVariant() {
  ...
  KNI_SetIntField(msg, KNI_GetFieldID(msgclass, "bodyBytes", "I"),
                  ((AJ_Message *)ptr)->bodyBytes);
  KNI_SetObjectField(
      variant, KNI_GetFieldID(variantclass, "value", "Ljava/lang/String;"),
      variantvalue);
  KNI_EndHandles();
  KNI_ReturnInt(res);
}
...
KNIEXPORT KNI_RETURNTYPE_INT Java_AllJoyn_unmarshalRaw() {
  ...
  char *data = malloc(sizeof(*data) * (buflen + 1));
  jint res =
      AJ_UnmarshalRaw((AJ_Message *)ptr, (const void **)&data, buflen, &actual);
  int i;
  for (i = 0; i < actual; i++) {
...
AJ_Object *create_busobjects(int index) {
  ...
  for (i = 0; i < len; i++) {
    ...
    KNI_GetObjectField(
        busobj, KNI_GetFieldID(busobjclass, "path", "Ljava/lang/String;"),
        path);
    ...
    jint flags =
        KNI_GetIntField(busobj, KNI_GetFieldID(busobjclass, "flags", "I"));

    KNI_GetObjectField(busobj, KNI_GetFieldID(busobjclass, "interfaces",
                                              "[[Ljava/lang/String;"),
                       interfaces);
...
NativeImplementationType Java_AllJoyn_natives[] = {
    ...
    {"busHandleBusMessage",
     (NativeFunctionPtr)Java_AllJoyn_busHandleBusMessage},
    {"busReplyAcceptSession",
     (NativeFunctionPtr)Java_AllJoyn_busReplyAcceptSession},
    ...
    {"unmarshalPropertyArgs",
     (NativeFunctionPtr)Java_AllJoyn_unmarshalPropertyArgs},
...
ClassNativeImplementationType nativeImpl[] = {
    {"org/alljoyn/bus/AllJoyn", Java_AllJoyn_natives}, NATIVE_END_OF_LIST};
